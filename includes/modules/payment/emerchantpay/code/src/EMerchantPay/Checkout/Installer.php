...
class Installer extends \EMerchantPay\Base\Installer
{
    ...
    public static function installModule()
    {
        ...
        $db->Execute("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Enable eMerchantPay Checkout Module', '" . EMerchantPayCheckoutSettings::getCompleteSettingKey('STATUS') . "', 'true', 'Do you want to process payments via eMerchantPays Genesis Gateway?', '6', '3', 'emp_zfg_draw_toggle(', 'emp_zfg_get_toggle_value', now())");
